...
def get_filters():
    ...
    while(city.lower() not in CITY_DATA):
        ...
        if city not in CITY_DATA:
            print('Please pick a valid city from Chicago, New York city, or Washington.')
        else:
            break
    ...
    while (day.lower() not in days):
        day = input ('\n Enter a day of week between monday to sunday to explore the data: ')
        day = day.lower()
        if day not in days:
...
#prompt user to view data if wanted
def display_data(df):
